...
export default function Home() {
  ...
  // Create fade-in hooks for each section
  const fadeRefs = [
    useFadeInOnScroll(),
    useFadeInOnScroll(),
    useFadeInOnScroll(),
  ...
  // Shared style for all sections - height + padding like “Mūsų Mokytojai”
  const sectionStyle = {
    height: "100vh",
    paddingTop: "7rem", // py-28 = 112px (7rem)
    paddingBottom: "7rem",
  };
  ...
  return (
    <div className="flex flex-col h-screen bg-white text-gray-900 font-sans">
      ...
      <main className="flex flex-col flex-grow overflow-y-auto scroll-smooth snap-y snap-mandatory">
        ...
        <section
          ref={fadeRefs[0].ref}
          className={`w-full max-w-4xl px-4 text-center snap-start flex flex-col justify-center items-center mx-auto transition-opacity duration-700 ease-in-out ${
            fadeRefs[0].visible ? "opacity-100" : "opacity-0"
          }`}
          style={sectionStyle}
        >
        ...
        <section
          ref={fadeRefs[1].ref}
          className={`w-full flex flex-col justify-center items-center bg-gradient-to-br from-blue-100 to-white snap-start px-6 transition-opacity duration-700 ease-in-out ${
            fadeRefs[1].visible ? "opacity-100" : "opacity-0"
          }`}
          style={sectionStyle}
        >
        ...
        <section
          ref={fadeRefs[2].ref}
          className={`w-full flex flex-col justify-center items-center bg-white snap-start px-6 transition-opacity duration-700 ease-in-out ${
            fadeRefs[2].visible ? "opacity-100" : "opacity-0"
          }`}
          style={sectionStyle}
        >
        ...
        <section
          ...
          className={`w-full flex flex-col justify-center items-center bg-gradient-to-tr from-green-100 to-white snap-start px-6 transition-opacity duration-700 ease-in-out ${
            fadeRefs[3].visible ? "opacity-100" : "opacity-0"
          }`}
          style={sectionStyle}
        >
        ...
        <section
          ...
          className={`w-full flex flex-col justify-center items-center bg-gradient-to-bl from-purple-100 to-white snap-start px-6 transition-opacity duration-700 ease-in-out ${
            fadeRefs[4].visible ? "opacity-100" : "opacity-0"
          }`}
          style={sectionStyle}
        >

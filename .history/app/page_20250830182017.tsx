        ...
        <nav className="space-x-4">
          {loading ? (
            ...
            <div className="flex items-center space-x-4">
              ...
              {userRole === 'tutor' && (
                <Button onClick={() => router.push('/tutor_dashboard')} className="bg-green-600 hover:bg-green-700">
                  Tutor Dashboard
                </Button>
              )}
              {userRole === 'client' && (
                <Button onClick={() => router.push('/student_dashboard')} className="bg-green-600 hover:bg-green-700">
                  Student Dashboard
                </Button>
              )}
              <Button onClick={handleLogout} className="bg-gray-200 text-gray-700 hover:bg-gray-300">
                Logout
              </Button>
            </div>
          ) : (
            <>
              <Button onClick={() => router.push("/auth/log-in")} className="bg-blue-600 hover:bg-blue-700">
                Log In
              </Button>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 w-full max-w-4xl">
            {lessons.map((lesson) => (
              <Button
                key={lesson.slug}
                className="w-full px-8 py-6 text-2xl font-semibold"

...
<section className="w-full min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-blue-400 to-bg-[#3B65CE] text-white snap-start px-6">
  {/* Puzzle Card */}
  <motion.div

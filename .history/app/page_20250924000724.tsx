...
>
  {/* Abstract Icons */}
  <svg
    className="absolute top-10 left-10 w-32 h-32 opacity-20 text-yellow-400"
    viewBox="0 0 100 100"
    fill="currentColor"
  >
  ...
  <svg
    className="absolute bottom-20 right-20 w-40 h-40 opacity-15 text-pink-400"
    viewBox="0 0 100 100"
    fill="currentColor"
  >
  ...
  <svg
    className="absolute top-1/2 left-1/2 w-60 h-60 -translate-x-1/2 -translate-y-1/2 opacity-10 text-white"
    viewBox="0 0 100 100"
    fill="currentColor"
  >
    <path d="M50,0 C77,0 100,23 100,50 C100,77 77,100 50,100 C23,100 0,77 0,50 C0,23 23,0 50,0 Z" />
  </svg>

  {/* Section content */}
  <h2 className="text-5xl font-extrabold mb-8 text-center text-white z-10">
    Mūsų misija ir vizija 
  </h2>

  <p className="max-w-3xl text-xl text-white leading-relaxed text-center z-10">

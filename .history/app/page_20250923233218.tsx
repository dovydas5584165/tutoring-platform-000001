...
import { FiCode, FiCalculator, FiFlask, FiMicroscope, FiBookOpen, FiGlobe } from "react-icons/fi";
...
<div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-4xl mb-12">
  {lessons.map((lesson, i) => {
    const icons = [FiCode, FiActivity, FiFlask, FiMicroscope, FiBookOpen, FiGlobe];
    const Icon = icons[i];
    return (
      <Button
        key={lesson.slug}
        className="w-full min-w-0 px-4 py-3 text-lg font-semibold rounded-2xl bg-[#3B65CE] text-white hover:bg-blue-700 transition-shadow duration-300 shadow-md flex items-center gap-2 justify-center"

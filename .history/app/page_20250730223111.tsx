...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-gray-900 font-sans">
      ...
      <main
        className="flex flex-col items-center overflow-y-scroll scroll-smooth snap-y snap-mandatory"
        style={{ height: "calc(100vh - 64px)" }} // subtract header height approx 64px
      >
        {/* First section: lesson buttons - normal height (let's make it big enough) */}
        <section className="w-full max-w-4xl px-4 text-center snap-start py-24">
        ...
        {/* New Section - full viewport height */}
        <section className="w-full flex flex-col justify-center items-center bg-gradient-to-br from-blue-100 to-white snap-start" style={{ height: "100vh" }}>
          <h2 className="text-5xl font-extrabold mb-8">Kaip tai veikia?</h2>
          <p className="max-w-2xl text-xl text-gray-700 leading-relaxed px-6">
        ...
        {/* Teachers Section - full viewport height */}
        <section
          className="w-full flex flex-col justify-center items-center bg-white snap-start"
          style={{ height: "100vh", padding: "7rem 1.5rem" }}
        >

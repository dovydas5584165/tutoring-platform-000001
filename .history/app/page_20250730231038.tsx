...
function AnimatedNumber({ value }: { value: number }) {
  ...
  return (
    <motion.div
      ...
      initial={{ count: 0 }}
      onUpdate={(latest) => {
        if (latest.count !== undefined) setCount(Math.floor(latest.count));
      }}
...
export default function Home() {
  ...
  const stats = [
    ...
    { icon: "🔟", number: 10, label: "metų patirties" },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-gray-900 font-sans">
      ...
      <main className="flex flex-col flex-grow overflow-y-auto scroll-smooth snap-y snap-mandatory">
        ...
        >
          <h2 className="text-5xl font-extrabold mb-8 text-center">Kaip tai veikia?</h2>

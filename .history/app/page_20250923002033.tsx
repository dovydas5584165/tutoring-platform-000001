...
>  
  ...
  <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-4xl mb-12">
    {lessons.map((lesson) => (
      <Button
        key={lesson.slug}
        className="inline-flex min-w-0 px-2 py-1 text-lg font-semibold rounded-xl bg-blue-600 text-white hover:bg-blue-700 transition-shadow duration-300 shadow-md"

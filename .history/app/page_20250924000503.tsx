      ...
      >
        ...
        {!showAnswer && (
          <input
            ...
            className="w-full p-2 border border-gray-300 bg-gray-200 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4"
          />
        )}

        {/* Fade out input when selected */}
        {selected && !showAnswer && (
          <motion.div
            initial={{ opacity: 1 }}
            animate={{ opacity: 0 }}
        ...
        {showAnswer && (
          <>
            ...
            <motion.p
              ...
              className="mt-6 text-gray-600 text-lg text-center max-w-md"
            >

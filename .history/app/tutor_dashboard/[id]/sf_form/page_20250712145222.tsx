...
// Initialize Supabase client (replace keys with your actual keys or environment variables)
...
export default function InvoiceGenerator() {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      if (error) {
        console.error("Failed to upload invoice:", error.message);
      ...
      // Increment invoice number & save locally

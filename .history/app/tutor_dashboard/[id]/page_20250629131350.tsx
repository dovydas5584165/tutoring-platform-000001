...
export default function TutorDashboard() {
  ...
  const params = useParams(); // gauname dinaminį id
  const tutorId = params?.id;

  // Pasirinkta data
  const [selectedDate, setSelectedDate] = useState<Date>(new Date());

  // Mock pamokos - realiai čia galėtum traukti iš DB pagal tutorId
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans flex flex-col">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4 flex flex-col sm:flex-row justify-between items-center gap-4">
        <h1 className="text-2xl font-bold">Sveiki, mokytojau {tutorId}!</h1>

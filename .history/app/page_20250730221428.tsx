...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-gray-900 font-sans">
      ...
      {/* Main */}
      <main className="flex flex-col items-center px-4 text-center overflow-hidden">
        <h1 className="text-4xl font-extrabold mt-16 mb-10">Pasirinkite pamoką</h1>

        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-4xl mb-32">
          {lessons.map((lesson) => (
            <button
              key={lesson.slug}
        ...
        {/* Section: Kaip tai veikia */}
        <section className="w-full bg-gradient-to-br from-blue-100 to-white py-28 px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-extrabold mb-8">Kaip tai veikia?</h2>
            <p className="text-xl text-gray-700 leading-relaxed">
              Pasirinkite pamoką, raskite jums tinkamą laiką, rezervuokite ir gaukite nuorodą į Google Meet. <br />
        ...
        {/* Section: Mokytojai */}
        <section className="w-full bg-white py-28 px-6 text-center">

...
>  
  ...
  <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-4xl mb-12">
    {lessons.map((lesson) => (
      <Button
        key={lesson.slug}
        className="w-full min-w-0 px-2 py-1.5 text-lg font-semibold rounded-2xl bg-blue-600 text-white hover:bg-blue-700 transition-shadow duration-300 shadow-md"

    ...
    {[
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-3">
          <span className="bg-blue-400 text-blue-700 px-3 py-1 rounded-full text-xs font-semibold">
            {teacher.subject}
          </span>
          <span className="bg-blue-100 text-white px-3 py-1 rounded-full text-xs font-medium">

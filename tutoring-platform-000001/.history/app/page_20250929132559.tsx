...
<section className="w-full min-h-screen flex flex-col justify-center items-center bg-[#3B65CE] text-white snap-start px-6"
>
  {/* Puzzle Card */}
  <motion.div
...
<section
  ...
  <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-4xl mb-12">
    {lessons.map((lesson) => (
      <Button
        key={lesson.slug}
        className="w-full min-w-0 px-4 py-3 text-lg font-semibold rounded-2xl bg-[#3B65CE] text-white hover:bg-blue-700 transition-shadow duration-300 shadow-md"

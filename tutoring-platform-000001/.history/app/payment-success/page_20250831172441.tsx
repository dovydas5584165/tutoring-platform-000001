  ...
  const sendInvoiceEmail = async (bookingId: string) => {
    ...
    try {
      ...
      if (response.ok && result.success) {
        setEmailStatus('sent');
        console.log('Prašymas sėkmingai išsiųstas:', result.messageId);
      } else {
          ...
          <div className="p-6">
              ...
              {emailStatus === 'sending' && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <p className="text-blue-700">Siunčiama sąskaita...</p>
                  </div>
                </div>
              )}
              ...
              {emailStatus === 'sent' && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <p className="text-green-700">✅ Sąskaita sėkmingai išsiųsta: {booking.student_email}</p>
                  </div>
                </div>
              )}
            ...
            <div className="mb-8">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <p><span className="font-medium">Kurso tema:</span> {booking.lesson_slug}</p>
                    <p><span className="font-medium">Tutores:</span> {booking.users ? `${booking.users.vardas} ${booking.users.pavarde}` : 'TBD'}</p>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium">Išsiųsta sąskaita</h4>
                    <p className="text-sm text-gray-600">Jums bus išsiųsta detalioji sąskaita el. paštu su visomis užsakymo detalėmis.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium">Tutores patvirtinimas laukia</h4>
                    <p className="text-sm text-gray-600">Tutores peržiūrės ir patvirtins jūsų užsakymą.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Patvirtinus, tutores susisieks su jumis tiesiogiai, kad suderintų pamokas.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              ...
              <p className="text-sm text-red-700">
                Jei tutores atšaukia jūsų užsakymą, pinigai bus grąžinti į originalią mokėjimo priemonę per 3-5 darbo dienas.
              </p>
            </div>

...
<motion.section
  ...
  className="w-full min-h-screen flex flex-col justify-center items-center bg-blue-600 snap-start px-6 py-20 relative overflow-hidden"
>
  {/* Section Title with abstract icons */}
  <h2 className="text-5xl font-extrabold mb-8 text-center text-white flex flex-col items-center gap-4">
    <span className="relative">
      <span>Mūsų misija</span>
      <span className="absolute -top-4 -left-6 w-6 h-6 bg-yellow-400 rounded-full opacity-70 animate-bounce"></span>
      <span className="absolute -bottom-2 -right-8 w-4 h-4 bg-pink-400 rounded-full opacity-50 animate-pulse"></span>
    </span>
    <span className="relative flex items-center gap-2">
      ...
      >
        <path
          d="M0 32C8 24 16 40 24 32C32 24 40 40 48 32C56 24 64 40 64 32V64H0V32Z"
          fill="#00BFFF"
          fillOpacity="0.7"
        />
      </svg>
  ...
  {/* Paragraph with small icon accents */}
  <p className="max-w-3xl text-xl text-white leading-relaxed text-center relative">
    <span className="absolute -top-6 -left-4 w-4 h-4 bg-yellow-500 rounded-full opacity-60 animate-ping"></span>
    <span className="absolute bottom-8 right-10 w-6 h-6 bg-pink-300 rounded-full opacity-30 animate-bounce"></span>
    <span className="font-bold text-yellow-300">Mūsų misija</span> – suteikti kiekvienam vaikui galimybę mokytis iš geriausių mokytojų, nepriklausomai nuo jų gyvenamos vietos ar galimybių.
    <br />
    <span className="font-bold text-yellow-300">Vizija</span> – būti Nr. 1 korepetitorių platforma Baltijos šalyse. 
    <span className="inline-block ml-2 w-6 h-6 align-middle">
      {/* Baltic Sea wave SVG small inline */}
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 32C8 24 16 40 24 32C32 24 40 40 48 32C56 24 64 40 64 32V64H0V32Z" fill="#00BFFF" fillOpacity="0.7"/>
      </svg>
    </span>
  </p>
</motion.section>
  ...
  <div className="flex gap-8 justify-center flex-wrap max-w-6xl mx-auto">
    {[
      ...
      >
        ...
        <p className="text- text-sm text-center">{teacher.description}</p>
      </div>
    ))}
  </div>
</motion.section>

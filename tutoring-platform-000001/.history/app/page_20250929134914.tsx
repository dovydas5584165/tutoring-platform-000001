...
>
  ...
  >
    <path
      d="M500 50 L540 70 L580 100 L600 140 L620 200 L610 250 L590 280 L570 300 L550 310 L530 320 L510 330 L490 340 L470 350 L450 360 L430 380 L410 400 L390 420 L370 440 L350 460 L330 480 L310 500 L290 520 L270 540 L250 560 L230 580 L210 600 L190 620 L170 640 L150 660 L130 680 L110 700 L90 720 L70 740 L50 760"
      fill="none"
      stroke="white"
      strokeWidth="2"
    />
    {/* You can add more <path> elements for more detailed Europe outline */}
  </svg>
...
<motion.section
  ...
  viewport={{ once: true }}
  transition={{ duration: 0.8 }}
  className="w-full min-h-screen flex flex-col justify-center items-center bg-[#3B65CE] snap-start px-4 py-16 sm:px-6 lg:px-20"
>

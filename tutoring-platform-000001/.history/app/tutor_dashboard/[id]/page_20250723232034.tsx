...
export default function TutorDashboard() {
  ...
  const handleNotificationResponse = async (notification: Notification, isYes: boolean) => {
    ...
    try {
      ...
      if (updateError) {
        alert("Klaida atnaujinant pranešimą: " + updateError.message);
        return;
      }
      ...
      // Update local state to mark as read and remove notification from UI
      setNotifications((prev) =>
        prev
          .map((n) => (n.id === notification.id ? { ...n, is_read: true } : n))

...
export default function TutorDashboard() {
  ...
  // Fetch availability slots for the tutor
  const fetchSavedSlots = async () => {
    ...
    if (error) {
      console.error("Nepavyko gauti prieinamumo:", error.message);
      return;
    }
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-8 py-8 grid grid-cols-1">
        <section className="bg-white rounded shadow p-6">
          ...
          <WeeklyAvailabilitySelector savedSlots={savedSlots} onSave={fetchSavedSlots} />
        </section>
      </main>

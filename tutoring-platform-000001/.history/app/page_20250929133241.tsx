...
>
  {/* Background Dots (grid layout) */}
  <div className="absolute inset-0 flex flex-wrap gap-8 justify-center items-center opacity-40">
  ...
  >
    <div className="relative inline-block">
      ...
      {/* Red rectangle accent (attached near text) */}
      <span className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-12 h-3 bg-red-500"></span>
    </div>

...
export default function RegistracijaPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-amber-50 via-emerald-50 to-green-100 p-6">
      <div className="w-full max-w-lg rounded-3xl bg-white p-10 shadow-xl border border-amber-200">
        <h1 className="text-center text-4xl font-extrabold mb-8 text-emerald-800 tracking-wide drop-shadow-sm">
          REGISTRACIJA
        </h1>

        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <select
            className="border border-amber-300 rounded-lg px-4 py-3 text-lg text-emerald-900 placeholder-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition"
            value={role}
          ...
          {role === "client" && (
            <input
              className="border border-amber-300 rounded-lg px-4 py-3 text-lg placeholder-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition"
              type="text"
          ...
          <fieldset className="border border-amber-300 rounded-lg p-4">
            <legend className="font-semibold text-emerald-800 mb-3 select-none">
              Pasirinkite pamokas:
            </legend>
            <div className="grid grid-cols-2 gap-3">
              {lessonsList.map((lesson) => {
                ...
                return (
                  <label
                    key={slug}
                    className="flex items-center cursor-pointer space-x-3 hover:text-emerald-700 transition"
                  >
                    <input
                      type="checkbox"
                      value={slug}
                      ...
                      className="h-5 w-5 rounded border-amber-400 text-emerald-600 focus:ring-amber-500"
                    />
          ...
          <input
            className="border border-blue-300 rounded-lg px-4 py-3 text-lg placeholder-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition"
            type="email"
          ...
          />
          <input
            className="border blue-amber-300 rounded-lg px-4 py-3 text-lg placeholder-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition"
            type="password"
          ...
          <button
            type="submit"
            className="mt-4 py-3 rounded-lg bg-blue-700 text-white font-semibold text-lg shadow-md hover:bg-emerald-800 focus:outline-none focus:ring-4 focus:ring-emerald-400 transition"
          >
            Užsiregistruoti
          </button>
        </form>

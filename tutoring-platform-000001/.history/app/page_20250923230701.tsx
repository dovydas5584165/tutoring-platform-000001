...
>
  ...
  {/* Step List as Tip Boxes */}
<div className="max-w-xl flex flex-col gap-6 mb-8">
  {[
    "1. Pasirink mokytoją iš mūsų patikrintos komandos.",
    "2. Rezervuok pamoką patogiu laiku.",
    "3. Apmokėk saugiai per mūsų sistemą.",
    "4. Gauk nuorodą el. paštu ir junkis prie pamokos!",
  ].map((tip, i) => (
    <div
      key={i}
